...
STORES = [
    ...
    # Todas as lojas lojistas operam no plano Start (Gratuito, R$ 0/mês). Apenas o tenant central é Enterprise.
    ("Auto Shopping Formula", "Auto Shopping", "Enterprise", "Ativo",   "3m 18s", 3842, 18400),
    ("Betania Automoveis",    "Lojista",       "Start",      "Ativo",   "2m 11s",  612,     0),
    ("GX Auto",               "Lojista",       "Start",      "Ativo",   "1m 49s",  438,     0),
    ("Radar Automóveis",      "Lojista",       "Start",      "Atenção", "5m 02s",  811,     0),
    ("JW Veiculos",           "Lojista",       "Start",      "Ativo",   "3m 40s",  392,     0),
    ("Trinity Veículos",      "Lojista",       "Start",      "Ativo",   "4m 15s",  287,     0),
    ("Betel Automóveis",      "Lojista",       "Start",      "Ativo",   "2m 30s",  450,     0),
    ("Dani Multimarcas",      "Lojista",       "Start",      "Ativo",   "3m 02s",  320,     0),
    ("EV Automóveis",         "Lojista",       "Start",      "Ativo",   "2m 48s",  510,     0),
    ("Evidence Multimarcas",  "Lojista",       "Start",      "Ativo",   "2m 05s",  490,     0),
    ("Gilson Automóveis",     "Lojista",       "Start",      "Ativo",   "4m 02s",  280,     0),
    ("Global Automóveis",     "Lojista",       "Start",      "Ativo",   "2m 22s",  430,     0),
    ("GR Car",                "Lojista",       "Start",      "Ativo",   "3m 14s",  295,     0),
    ("Kadosh Automóveis",     "Lojista",       "Start",      "Ativo",   "2m 55s",  460,     0),
    ("Kallicar Multimarcas",  "Lojista",       "Start",      "Ativo",   "3m 22s",  315,     0),
    ("Luan Multimarcas",      "Lojista",       "Start",      "Ativo",   "3m 48s",  300,     0),
    ("Meu Automóvel",         "Lojista",       "Start",      "Ativo",   "2m 14s",  420,     0),
    ("Mundial Automóveis",    "Lojista",       "Start",      "Ativo",   "2m 41s",  475,     0),
    ("Neri Veículos",         "Lojista",       "Start",      "Ativo",   "3m 33s",  310,     0),
    ("Rocha Motors",          "Lojista",       "Start",      "Ativo",   "2m 19s",  445,     0),
    ("RS Motors",             "Lojista",       "Start",      "Ativo",   "3m 56s",  305,     0),
    ("Seminovos Movida",      "Lojista",       "Start",      "Ativo",   "1m 38s",  680,     0),
    ("Tex Veículos",          "Lojista",       "Start",      "Ativo",   "2m 29s",  455,     0),
]
