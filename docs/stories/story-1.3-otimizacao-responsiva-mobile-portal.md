...
- [x] **AC3 (Filtro Retrátil Inteligente no Catálogo de Estoque)**:
...
- [x] **AC4 (Simulador de Financiamento e Detalhes do Veículo)**:
...
- [x] **AC5 (Responsividade Institucional & Quero Vender)**:
...
- [x] **AC6 (Ergonomia do Botão Flutuante do WhatsApp & Cache Busting)**:
...
- [x] **AC7 (Validação Automatizada e Regressão Zero)**:
...
- [x] **Task 1 (CSS Global & Topbar/Navbar)**:
...
- [x] **Task 2 (Catálogo de Estoque - Filtros Móveis)**:
...
- [x] **Task 3 (Simulador e Detalhes do Veículo)**:
...
- [x] **Task 4 (Páginas Quero Vender, Lojas e Rodapé)**:
...
- [x] **Task 5 (Cache Busting em todos os HTMLs)**:
...
- [x] **Task 6 (Auditoria e Validação Mobile)**:
